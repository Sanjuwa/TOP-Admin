                      ...
                      children: [
                        Padding(
                          padding: EdgeInsets.only(
                              bottom: getDeviceType() == Device.Tablet ? 10.h : 8.h),
                          child: Container(
                            ...
                            child: DropdownButton<Hospital>(
                              ...
                              hint: Text(
                                ...
                                style: TextStyle(
                                    color: kDisabled,
                                    fontSize: getDeviceType() == Device.Tablet ? 20.sp : null),
                              ),
                              ...
                              items: allHospitals
                                  .map((hospital) => DropdownMenuItem(
                                      ...
                                      child: Text(
                                        ...
                                        style: TextStyle(
                                            fontSize:
                                                getDeviceType() == Device.Tablet ? 20.sp : null),
                                      )))
                                  .toList(),
                              onChanged: (value) {
                        ...
                        Padding(
                          padding: EdgeInsets.symmetric(
                              vertical: getDeviceType() == Device.Tablet ? 20.h : 15.h),
                          child: Container(
                            alignment: getDeviceType() == Device.Tablet ? Alignment.center : null,
                            height: getDeviceType() == Device.Tablet ? 100 : null,
                            width: double.infinity,
